...
class HexapodLegPower:
    ...
    def render(self) -> None:
        ...
        x_range: npt.NDArray[np.floating] = np.arange(self._x_min, self._x_max + 1, self._step)
        z_range: npt.NDArray[np.floating] = np.arange(self._z_min, self._z_max + 1, self._step)
